...
import static nandortoth.airlock.R.layout.activity_first;
...
public class FirstActivity extends AppCompatActivity {
    ...
    private BluetoothAdapter btAdapter = BluetoothAdapterUtil.getBtAdapter();
    ...
    Thread BluetoothConnectionThread = new Thread() //thread to start the connection
    {
        public void run()
        {
